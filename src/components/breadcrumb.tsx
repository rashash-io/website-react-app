    ...
    return (
      <div className=" flex justify-center py-2 rounded-lg ">
        <Breadcrumb dir={rtlVal}>
          <BreadcrumbList className="flex items-center justify-center bg-black-950/40   rounded-xl px-4 py-1.5 border-2 border-primary/50 shadow-sm shadow-primary/50">
            <BreadcrumbItem>
